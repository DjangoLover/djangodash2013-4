...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Card'
        db.create_table(u'projects_card', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
            ('content', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('content_markdown', self.gf('django.db.models.fields.TextField')()),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='card', to=orm['projects.Project'])),
            ('board', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Board'])),
        ...
        db.send_create_signal(u'projects', ['Card'])


    def backwards(self, orm):
        # Deleting model 'Card'
        db.delete_table(u'projects_card')
